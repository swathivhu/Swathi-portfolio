 ...
 */
const LinkedInIcon = () => (
  <svg role="img" viewBox="0 0 24 24" fill="#0077B5" className="w-5.5 h-5.5">
    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452z" />
  </svg>
);

const GmailIcon = () => (
  <svg role="img" viewBox="0 0 24 24" fill="#EA4335" className="w-5.5 h-5.5">
...
export const Sidebar: React.FC = () => {
  return (
    <aside className="w-full lg:w-80 xl:w-96 lg:fixed h-screen left-auto top-0 p-4 z-40 flex flex-col items-center justify-center">
      ...
      {/* Main Identity Card */}
      <div className="w-full h-auto bg-black border border-white/5 rounded-[3rem] py-8 px-6 flex flex-col items-center shadow-2xl relative">
        
        {/* 1. Avatar Section */}
        <div className="relative w-[120px] h-[120px] mb-6 group">
          <div className="absolute inset-0 rounded-full bg-primary/20 blur-md group-hover:bg-primary/40 transition-all duration-500" />
          <div className="relative w-full h-full rounded-full border border-primary/40 p-1 bg-black z-10 overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-1 mb-8">
          ...
          <div className="text-[10px] font-mono font-bold uppercase text-primary tracking-[0.3em]">
            AI SYSTEM ARCHITECT
          </div>
        </div>

        {/* 3. Flight Location Card */}
        <div className="w-full bg-[#10b981] rounded-3xl p-5 text-white shadow-[0_10px_30px_rgba(16,185,129,0.3)] mb-6">
          <div className="flex justify-between items-start mb-2">
            <div className="flex flex-col">
              <div className="flex items-baseline gap-1">
                <span className="text-xl font-bold">IND</span>
                <span className="text-[9px] font-bold opacity-80 uppercase">IN</span>
              </div>
              <span className="text-[8px] font-mono uppercase tracking-widest opacity-80">INDIA</span>
            </div>
            
            <div className="flex-1 flex justify-center pt-1 opacity-60">
            ...
            <div className="flex flex-col items-end">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xl font-bold">BLR</span>
              </div>
          ...
          <div className="pt-3 border-t border-white/20 text-center space-y-0.5">
            <div className="text-[7px] font-mono uppercase tracking-[0.2em] opacity-70">CURRENT STATUS</div>
        ...
        {/* 4. Expertise Modular Stack */}
        <div className="w-full bg-[#111827]/40 border border-primary/20 rounded-3xl p-6 flex flex-col items-center gap-4 mb-8 relative">
          <div className="absolute right-[-6px] top-1/2 -translate-y-1/2 w-3 h-3 bg-primary rounded-full shadow-[0_0_10px_rgba(16,185,129,0.8)]" />
        ...
        <div className="flex flex-row justify-center gap-4 w-full">
          {[
            ...
            <a
              ...
              className="w-11 h-11 flex items-center justify-center rounded-full bg-white/[0.03] border border-white/10 hover:bg-white/[0.08] transition-all duration-300"
            >
              <social.icon />
            </a>
          ))}
